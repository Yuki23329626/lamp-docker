...
container_id_1=`docker ps | grep lamp-docker | grep apache | cut -c1-12`
container_id_2=`docker ps | grep lamp-docker | grep db | cut -c1-12`
container_id_3=`docker ps | grep lamp-docker | grep adminer | cut -c1-12`
